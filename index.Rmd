...
* **Lesson on Tuesday at 13:00 pm** lasting 90 minutes in Room 009.
...
2. [Data Structures](week2.html)  - An introduction to R data structures
...
7. [Generating reports with RMarkdown](week7_Rmarkdown.html)  - Using Rmarkdown for reproducible research
7. [Generating reports with Quarto](week7_Quarto.html)  - Using Quarto for reproducible research

8. [Restructuring data for analysis](week8.html)  - The concept of 'tidy data', pivoting and separating operations, ggplot2 extras
